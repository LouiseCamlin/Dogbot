...
Dog.create({breed: "Brussels Griffon.", fact: "A breed of toy dog from Brussels, Belgium. Comes in three variations: the Griffon Bruxellois, the Griffon Belge and the Petit Brabançon."})
...
Dog.create({breed: "Coton de Tulear.", fact: "Named Coton, which is French for cotton, due to the breeds resemblance to a cotton ball. The Tulear part of their name comes from the city of Tuléar in Madagascar and is the islands natiional dog."})
...
Dog.create({breed: "Leonberger.", fact: "Coming from Leonberg in Baden-Württemberg, Germany, this breed is a giant mountian dog. Believed to be a cross between a Newfoundland and a St. Bernard. One of the breeds used by the Canadian government water rescue/lifesaving dogs."})
...
Dog.create({breed: "Löwchen.", fact: "Also known as Little Lion Dog. Considered one of the rarest breeds there are typically less than 100 registrations worldwide each year."})
